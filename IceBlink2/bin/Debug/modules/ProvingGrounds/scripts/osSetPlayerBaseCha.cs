//osSetPlayerBaseCha.cs - Set the Player's Charisma Attribute Base to a new value permanently
...
//for example, to add 1 to miki's charisma (miki,,+,1). To set the first PC's charisma to something between 10 and 15 [ ,0,=,rand(10-15)]
