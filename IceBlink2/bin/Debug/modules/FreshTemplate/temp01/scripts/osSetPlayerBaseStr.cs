//osSetPlayerBaseStr.cs - Set the Player's Strength Attribute Base to a new value permanently
...
//for example, to add 1 to miki's strength (miki,,+,1). To set the first PC's strength to something between 10 and 15 [ ,0,=,rand(10-15)]
