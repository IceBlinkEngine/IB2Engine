   ...
   public  class IceBlinkButtonClose : System.Windows.Forms.Button
    {
       ...
       public IceBlinkButtonClose()
       {
           ...
           this.BackgroundImage = global::IceBlink2.Properties.Resources.b_close_normal;
           ...
           this.HoverImage = global::IceBlink2.Properties.Resources.b_close_normal;
           this.Name = "iceBlinkButtonRArrow1";
           this.NormalImage = global::IceBlink2.Properties.Resources.b_close_normal;
           this.PressedImage = global::IceBlink2.Properties.Resources.b_close_normal;
       ...
       private void loadButtonImages(GameView gv)
       {
           try
           {
               if (gv.mod != null)
               {
                   ...
                   {
                       this.BackgroundImage = (Image)new Bitmap(gv.mainDirectory + "\\modules\\" + gv.mod.moduleName + "\\ui\\btn_close_normal.png");
                       this.HoverImage = (Image)new Bitmap(gv.mainDirectory + "\\modules\\" + gv.mod.moduleName + "\\ui\\btn_close_hover.png");
                       this.NormalImage = (Image)new Bitmap(gv.mainDirectory + "\\modules\\" + gv.mod.moduleName + "\\ui\\btn_close_normal.png");
                       this.PressedImage = (Image)new Bitmap(gv.mainDirectory + "\\modules\\" + gv.mod.moduleName + "\\ui\\btn_close_pressed.png");
                   }
                   else
                   {
                       this.BackgroundImage = (Image)new Bitmap(gv.mainDirectory + "\\default\\NewModule\\ui\\btn_close_normal.png");
                       this.HoverImage = (Image)new Bitmap(gv.mainDirectory + "\\default\\NewModule\\ui\\btn_close_hover.png");
                       this.NormalImage = (Image)new Bitmap(gv.mainDirectory + "\\default\\NewModule\\ui\\btn_close_normal.png");
                       this.PressedImage = (Image)new Bitmap(gv.mainDirectory + "\\default\\NewModule\\ui\\btn_close_pressed.png");
                   }
               }
               else
               {
