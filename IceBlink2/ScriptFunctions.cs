                    ...
                    if (thisSpellEffect.doDamage)
                    {
                        ...
                        for (int i = 0; i < numberOfAttacks; i++)
                        {
                            ...
                            if (saveChk >= DC) //passed save check (do half or avoid all?)
                            {
                                ...
                                if (mod.debugMode) { gv.cc.addLogText("<font color='yellow'>" + saveChkRoll + " + " + crt.reflex + " >= " + DC + "</font><BR>"); }
                            }
