                    ...
                    foreach (string file in files)
                    {
                        try
                        {
                            ...
                            if (filename.EndsWith(".png"))
                            {
                                ...
                                {
                                    if ((t.Layer0Filename.Equals(fileNameWithOutExt)) ||
                                        (t.Layer1Filename.Equals(fileNameWithOutExt)) || 
...
//                                    gv.Render();
        ...
        public void createSpritesForTesting()
        {
            for (int i = 0; i < 100; i++)
            {
                Sprite spr = new Sprite(gv, "hit_symbol", gv.sf.RandInt(1000), gv.sf.RandInt(1000), (float)(gv.sf.RandInt(100) + 1) / 1000f, (float)(gv.sf.RandInt(100) + 1) / 1000f, 0, (float)(gv.sf.RandInt(100) + 1) / 10000f, 1.0f, gv.sf.RandInt(10000) + 3000, 0, false, 100);
